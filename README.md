...
# Important End-user Info
## Test Account:
Test Account Login: test@gmail.com Password: test123
## To View Calender Events you need to long-hold on the required Date
## HOW TO GET CANVAS API KEY
1. Login to learn.ontariotechu.ca
2. Click Account on the Sidebar on the Left
3. Click Settings from the expanded sidebar
4. Scroll Down to Approved Integrations
5. Generate a new Access Token
6. Insert said token into the SET Canvas API pop-up within the App
...
1. Alyssa Tian (Alyssa-tian)

2. Kishore Muralitharan (BillDoesScience)

3. David Watt (DAVID8822
